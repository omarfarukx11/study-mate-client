    ...
    <div className="min-h-screen w-[1536px] mx-auto bg-gray-100 p-6 md:p-10">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-8">
        <input
          ...
          className="w-full md:w-2/3 px-4 py-2 border-2 border-green-400 rounded-lg focus:outline-none focus:border-green-500 text-sm md:text-base"
          value={searchTerm}
          onChange={(e) => setSearchTerm(e.target.value)}
        />

        <select
          className="w-full md:w-1/4 px-3 py-2 border-2 border-green-400 rounded-lg text-sm md:text-base"
          value={sortOption}
