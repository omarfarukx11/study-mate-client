      ...
      <div className="p-4 flex flex-col grow">
        ...
        <div className="mt-auto pt-3 dark:border-zinc-800">
          <Link
            ...
            className="w-full inline-flex items-center justify-center bg-primary dark:bg-primary text-base-100 text-xs font-bold py-2.5 rounded-4xl transition-all hover:bg-neutral dark:hover:bg-primary/80 active:scale-95"
          >
            View Profile
          </Link>
        </div>
