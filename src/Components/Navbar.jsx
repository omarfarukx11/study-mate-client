...
const Navbar = () => {
  ...
  const links = (
    <>
      <li>
        <NavLink to="/" className="flex lg:items-center justify-center gap-1">
          <span>
            <IoHomeOutline />
          </span>
          Home
      ...
      <li>
        <NavLink to="/aboutUs"  className="flex lg:items-center justify-center gap-1"> <span><SlPeople /></span> About US</NavLink>
      </li>
      {!user && (
        <>
          <li>
