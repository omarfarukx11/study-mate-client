        ...
        <div className=" hidden lg:flex">
          ...
          {user && (
            <div className="dropdown dropdown-end">
              ...
              <ul
                tabIndex="-1"
                className="dropdown-content flex flex-col bg-base-100 rounded-box z-1 w-52 p-4 shadow-sm"
              >
                <li className="btn bg-[#5BBC2E] text-white hover:bg-white hover:border-2 hover:border-[#5BBC2E] hover:text-[#5BBC2E] ">
                  <Link className="no-style-link" to={"/profile"}>
                    Profile
                  </Link>
                </li>
                <li
