...
const ReviewCard = ({ comment }) => {
  ...
  return (
    <div className="card bg-base-100 shadow-xl p-6 lg:w-[500px] w-[200px] space-x-5 lg:h-[300px] h-[200px] mx-auto">
      <div className="flex flex-col items-center text-center">
        ...
        />
        <h3 className="lg:text-xl text-sm font-semibold text-gray-800">{name}</h3>

        <div className="flex justify-center text-[10px] items-center my-2 space-x-1">
          {stars}
        </div>

        <p className="text-gray-600 lg:text-base text-[8px] leading-relaxed">
          {review}
        </p>
      </div>
    </div>
